...
CREATE INDEX "submissions_uid_idx" ON "submissions" USING btree ("uid","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "submissions_client_nonce_key" ON "submissions" USING btree ("uid","client_nonce");